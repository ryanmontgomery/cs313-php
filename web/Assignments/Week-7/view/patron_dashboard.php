...
<div class="row-100">
    ...
    <div id="add_patron" class="dashboard_section col-50">
        <h2>New Patron</h2>
        <form action="index.php" method="post">
            ...
            <label for="new_address1">Address 1:</label><br>
            <input id="new_address1" type="text" name="address1" required><br>
            <label for="new_address2">Address 2:</label><br>
            ...
            <label for="new_state">State:</label><br>
            <input id="new_state" type="text" name="state" required><br>
            <label for="new_zip_code">Zip Code:</label><br>
